...
Run the offline prototype to visualise detection on saved frames:
    ...
    python3 -m src.features.autonomous_detection.free_space
...
if __name__ == "__main__":
    ...
    if _args and not (_args & _FLAGS):
        # Static image mode: python3 -m src.features.autonomous_detection.free_space frame.jpg
        ...
        if "--stream" in _args:
            ...
            # python3 -m src.features.autonomous_detection.free_space --live
