...
from src.features.autonomous_detection.free_space import detect, MIN_CONFIDENCE
...
from src.components.core.config import MOTOR_CFG, AUTONOMOUS_CFG, SERVO_CFG

from src.features.autonomous_detection.sweep_cache import (
    _SweepCache,
...
from src.features.autonomous_movement.avoidance import (
...
# from src.components.core.config import ULTRASONIC_REAR_CFG  # rear ultrasonic not installed
...
async def run_autonomous(controller, obstacle, camera, websocket):
    ...
    # from src.components.core.config import ULTRASONIC_REAR_CFG
