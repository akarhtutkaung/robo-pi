...
- [x] `src/features/autonomous_detection/free_space.py` — column-wise Canny edge density → (error, confidence)
  - run offline: `python3 -m src.features.autonomous_detection.free_space frame.jpg`
  - run live + save frames: `python3 -m src.features.autonomous_detection.free_space --live`
...
## PID Steering
- [ ] `src/components/navigation/pid.py` — minimal PID class with integral windup clamp
